...
class PlanController extends Controller
{
    ...
    public function create(Request $request, $id)
    {
        ...
        return view('clinic-users.plans.plans_registration', [
            'mode' => 'create',
            'page_header_title' => $user->last_name . '&ensp;' . $user->first_name . '&ensp;様の計画情報新規登録',
            'id' => $id,
            'planInfo' => $planInfo,
    ...
    public function edit(Request $request, $id, $plan_id)
    {
        ...
        return view('clinic-users.plans.plans_registration', [
            'mode' => 'edit',
            'page_header_title' => $user->last_name . '&ensp;' . $user->first_name . '&ensp;様の計画情報編集',
            'id' => $id,
            'plan_id' => $plan_id,
            'planInfo' => $planInfo,
            'assistanceLevels' => $assistanceLevels,
    ...
    public function duplicateForm(Request $request, $id, $plan_id)
    {
        ...
        return view('clinic-users.plans.plans_registration', [
            'mode' => 'duplicate',
            'page_header_title' => $user->last_name . '&ensp;' . $user->first_name . '&ensp;様の計画情報複製',
            'id' => $id,
            'plan_id' => $plan_id,
            'planInfo' => $planInfo,
            'assistanceLevels' => $assistanceLevels,
