  ...
  <div class="row g-3 m-3" style="max-width: 30%;">
    ...
    <div class="col-12">
      <a href="{{ route('clinic-users.index') }}" class="btn-ex-main btn-ex-blue btn-ex-rounded-full">
        <div class="btn-ex-skin btn-ex-white btn-ex-xs btn-ex-rounded-full aspect-square" style="padding: 0.9rem; margin: -0.125rem;">
          <i class="nf nf-fa-user fs-7-5 m-n3"></i>
        </div>
        <div class="ms-4 me-3">利用者（{{ $clinicUserCount }}件）</div>
      </a>
    </div>
    <div class="col-12">
      <a href="{{ route('doctors.index') }}" class="btn-ex-main btn-ex-blue btn-ex-rounded-full">
        ...
        <div class="ms-4 me-3">医師（{{ $doctorCount }}件）</div>
      </a>
    </div>
    <div class="col-12">
      <a href="{{ route('therapists.index') }}" class="btn-ex-main btn-ex-blue btn-ex-rounded-full">
        ...
        <div class="ms-4 me-3">施術者（{{ $therapistCount }}件）</div>
      </a>
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
      <a href="{{ route('master.self-fees.index') }}" class="btn-ex-main btn-ex-blue btn-ex-rounded-full">
        ...
        <div class="ms-4 me-3">自費施術料金</div>
      </a>
    </div>
    <div class="col-12">
      <a href="{{ route('master.document-association.index') }}" class="btn-ex-main btn-ex-blue btn-ex-rounded-full">
        <div class="btn-ex-skin btn-ex-white btn-ex-xs btn-ex-rounded-full aspect-square" style="padding: 0.9rem; margin: -0.125rem;">
          <i class="nf nf-oct-link fs-7-5 fw-bold m-n3"></i>
        </div>
        <div class="ms-4 me-3">登録済み標準文書の確認･関連付け</div>
      </a>
    </div>
  </div>
</x-app-layout>
