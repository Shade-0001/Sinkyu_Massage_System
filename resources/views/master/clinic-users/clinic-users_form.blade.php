...
<form action="{{ $action }}" method="POST">
  ...
  <div class="d-flex flex-column gap-2" style="max-width: 600px;">
    ...
    {{-- 氏名 --}}
    <div>
      <label class="form-label small fw-semibold mb-1">氏名
    ...
    {{-- フリガナ --}}
    <div>
      <label class="form-label small fw-semibold mb-1">フリガナ
    ...
    {{-- 生年月日 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="birthday">生年月日</label>
      <div>
    ...
    {{-- 年齢 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="age">年齢
    ...
    {{-- 性別 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="gender_id">性別</label>
      <div>
    ...
    {{-- 郵便番号 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="postal_code">郵便番号
    ...
    {{-- 都道府県 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="address_1">都道府県
    ...
    {{-- 市区町村番地以下 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="address_2">市区町村番地以下
    ...
    {{-- アパート・マンション名等 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="address_3">アパート・マンション名等
    ...
    {{-- 電話番号 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="phone">電話番号</label>
      <div>
    ...
    {{-- 携帯番号 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="cell_phone">携帯番号</label>
      <div>
    ...
    {{-- FAX番号 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="fax">FAX番号</label>
      <div>
    ...
    {{-- メールアドレス --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="email">メールアドレス</label>
      <div>
    ...
    {{-- 往診距離 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="housecall_distance">往診距離（合計）</label>
      <div>
    ...
    {{-- 往診加算距離 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="housecall_additional_distance">往診加算距離</label>
    ...
    {{-- 償還対象 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="is_redeemed">償還対象</label>
      <div>
    ...
    {{-- 申請書提出開始回数 --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="application_count">申請書提出開始回数<span class="fw-normal ms-1">［大阪市のみ］</span></label>
      <div>
    ...
    {{-- メモ --}}
    <div>
      <label class="form-label small fw-semibold mb-1" for="note">メモ</label>
      <div>
