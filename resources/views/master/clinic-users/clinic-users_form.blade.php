...
<form action="{{ $action }}" method="POST">
  ...
  <div class="d-flex flex-column gap-2" style="max-width: 600px;">
    ...
    <div class="border rounded-1">
      <div class="px-3 py-2 small fw-semibold">氏名
    ...
    {{-- フリガナ --}}
    <div class="border rounded-1">
      <div class="px-3 py-2 small fw-semibold">フリガナ
    ...
    {{-- 生年月日 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="birthday">生年月日</label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- 年齢 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="age">年齢
    ...
    {{-- 性別 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="gender_id">性別</label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- 郵便番号 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="postal_code">郵便番号
    ...
    {{-- 都道府県 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="address_1">都道府県
    ...
    {{-- 市区町村番地以下 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="address_2">市区町村番地以下
    ...
    {{-- アパート・マンション名等 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="address_3">アパート・マンション名等
    ...
    {{-- 電話番号 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="phone">電話番号</label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- 携帯番号 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="cell_phone">携帯番号</label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- FAX番号 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="fax">FAX番号</label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- メールアドレス --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="email">メールアドレス</label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- 往診距離 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="housecall_distance">往診距離（合計）</label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- 往診加算距離 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="housecall_additional_distance">往診加算距離</label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- 償還対象 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="is_redeemed">償還対象</label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- 申請書提出開始回数 --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="application_count">申請書提出開始回数<span class="fw-normal ms-1">［大阪市のみ］</span></label>
      <hr class="m-0">
      <div class="px-3 py-2">
    ...
    {{-- メモ --}}
    <div class="border rounded-1">
      <label class="d-block px-3 py-2 small fw-semibold" for="note">メモ</label>
      <hr class="m-0">
      <div class="px-3 py-2">
