<x-app-layout>
  ...
  <!-- 同意医師履歴印刷ボタン -->
  <button type="button" id="printConsentingHistory" class="btn-ex-main btn-ex-blue ms-2" data-print-url="{{ route('clinic-users.consents-acupuncture.print-history', $id) }}">PDF出力｜同意医師履歴</button>
  <br><br>
