  ...
  <div class="container-fluid">
    ...
    <div class="mb-4">
      <div class="d-flex align-items-center">
        ...
        <button type="button" id="weekly-schedule-print-btn" class="btn-ex-main btn-ex-blue me-1">PDF出力｜週間スケジュール</button>
        <button type="button" id="monthly-schedule-print-btn" class="btn-ex-main btn-ex-blue">PDF出力｜月間スケジュール</button>
      </div>
    </div>
