<x-app-layout>
  ...
  <div class="row g-2 mb-4">
    ...
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#3498db;border-color:#3498db;color:#fff;" onclick="openMedicalAssistanceModal('acupuncture')">医療助成費支給申請書</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#3498db;border-color:#3498db;color:#fff;" onclick="openLateElderlyMedicalModal('acupuncture')">後期高齢者医療療養費支給申請書</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#3498db;border-color:#3498db;color:#fff;" onclick="openConsentRequestSampleModal('acupuncture')">同意書依頼状 (サンプル版)</button></div>
    <div class="w-100"></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#3498db;border-color:#3498db;color:#fff;" onclick="openConsentRequestDesignatedModal('acupuncture')">同意書依頼状 (医師指定)</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#3498db;border-color:#3498db;color:#fff;" onclick="openConsentFormModal('acupuncture')">同意書</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#3498db;border-color:#3498db;color:#fff;" onclick="openTreatmentFeeListModal('acupuncture')">施術料金一覧表(保険)</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#3498db;border-color:#3498db;color:#fff;" onclick="openSelfFeeListModal()">施術料金一覧表(自費)</button></div>
    <div class="col d-flex gap-2">
      <button type="button" class="btn flex-fill text-nowrap" style="background-color:#3498db;border-color:#3498db;color:#fff;" onclick="openTreatmentRecordModal('acupuncture')">施術録</button>
      <button type="button" class="btn flex-fill text-nowrap" style="background-color:#3498db;border-color:#3498db;color:#fff;" onclick="openSummaryTableModal('acupuncture')">総括表</button>
    </div>
  </div>
  ...
  <div class="row g-2 mb-4">
    ...
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#1a6bb5;border-color:#1a6bb5;color:#fff;" onclick="openMedicalAssistanceModal('massage')">医療助成費支給申請書</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#1a6bb5;border-color:#1a6bb5;color:#fff;" onclick="openLateElderlyMedicalModal('massage')">後期高齢者医療療養費支給申請書</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#1a6bb5;border-color:#1a6bb5;color:#fff;" onclick="openConsentRequestSampleModal('massage')">同意書依頼状 (サンプル版)</button></div>
    <div class="w-100"></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#1a6bb5;border-color:#1a6bb5;color:#fff;" onclick="openConsentRequestDesignatedModal('massage')">同意書依頼状 (医師指定)</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#1a6bb5;border-color:#1a6bb5;color:#fff;" onclick="openConsentFormModal('massage')">同意書</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#1a6bb5;border-color:#1a6bb5;color:#fff;" onclick="openTreatmentFeeListModal('massage')">施術料金一覧表(保険)</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#1a6bb5;border-color:#1a6bb5;color:#fff;" onclick="openSelfFeeListModal()">施術料金一覧表(自費)</button></div>
    <div class="col d-flex gap-2">
      <button type="button" class="btn flex-fill text-nowrap" style="background-color:#1a6bb5;border-color:#1a6bb5;color:#fff;" onclick="openTreatmentRecordModal('massage')">施術録</button>
      <button type="button" class="btn flex-fill text-nowrap" style="background-color:#1a6bb5;border-color:#1a6bb5;color:#fff;" onclick="openSummaryTableModal('massage')">総括表</button>
    </div>
  </div>
  ...
  <div class="row row-cols-4 g-2 mb-4">
    ...
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e67e22;border-color:#e67e22;color:#fff;" onclick="submitPowerOfAttorneyConsent()">委任状（同意書取得）</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e67e22;border-color:#e67e22;color:#fff;" onclick="openPaymentListModal()">入金管理表（保険）</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e67e22;border-color:#e67e22;color:#fff;" onclick="openDoctorThankYouModal()">医師への御礼状</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e67e22;border-color:#e67e22;color:#fff;" onclick="openReferrerThankYouModal()">紹介者への御礼状</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e67e22;border-color:#e67e22;color:#fff;" onclick="openUserCountSummaryModal()">利用者数集計表</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e67e22;border-color:#e67e22;color:#fff;" onclick="openImplementationPlanModal()">実施計画書</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e67e22;border-color:#e67e22;color:#fff;" onclick="openReportGreetingModal()">報告書挨拶文</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e67e22;border-color:#e67e22;color:#fff;" onclick="openReportModal()">報告書</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e67e22;border-color:#e67e22;color:#fff;" onclick="openScheduleListModal()">予定表</button></div>
  ...
  <div class="row row-cols-4 g-2 mb-4">
    ...
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e74c3c;border-color:#e74c3c;color:#fff;" onclick="submitClinicUserConsentInfoList()">利用者情報一覧（同意医師情報）</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e74c3c;border-color:#e74c3c;color:#fff;" onclick="submitDoctorInfoList()">医師情報一覧</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e74c3c;border-color:#e74c3c;color:#fff;" onclick="submitCareManagerInfoList()">ケアマネ情報一覧</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e74c3c;border-color:#e74c3c;color:#fff;" onclick="submitTherapistInfoList()">施術者情報一覧</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e74c3c;border-color:#e74c3c;color:#fff;" onclick="openAddressLabelModal()">宛名シール・住所データCSV出力</button></div>
    <div class="col"><button type="button" class="btn w-100 text-nowrap" style="background-color:#e74c3c;border-color:#e74c3c;color:#fff;" onclick="submitFaxCoverSheet()">FAX送信票表示</button></div>
  </div>
