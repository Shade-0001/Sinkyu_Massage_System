<x-app-layout>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a class="btn-custom btn-custom-blue btn-custom-sm" href="{{ route('notices.edit', ['id' => $notice->id]) }}">編集</a>
        <a class="btn-custom btn-custom-blue btn-custom-sm" href="{{ route('notices.duplicate', ['id' => $notice->id]) }}">複製</a>
      </td>
      <td>
