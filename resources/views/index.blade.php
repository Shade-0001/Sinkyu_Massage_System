<x-app-layout>
  ...
  <div class="mt-2 mx-1 row-gap-4 user-select-none" style="display:grid; grid-template-columns:1fr 1fr; grid-template-rows:repeat(4, auto); grid-auto-flow:column;">
    <a class="text-decoration-none text-reset d-flex " href="{{ route('records.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black text-nowrap mt-2" style="letter-spacing: 0.2rem">実績データ</div>
    ...
    <a class="text-decoration-none text-reset d-flex " href="{{ route('reports.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black text-nowrap mt-1" style="letter-spacing: 0.2rem">報告書データ</div>
    ...
    <a class="text-decoration-none text-reset d-flex " href="{{ route('schedules.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black text-nowrap mt-1" style="letter-spacing: 0.2rem">スケジュール</div>
    ...
    <a class="text-decoration-none text-reset d-flex " href="{{ route('master.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black text-nowrap mt-1" style="letter-spacing: 0.2rem">マスター登録</div>
    ...
    <a class="text-decoration-none text-reset d-flex " href="{{ route('submaster.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black text-nowrap mt-1" style="letter-spacing: 0.2rem">サブマスター登録</div>
    ...
    <a class="text-decoration-none text-reset d-flex " href="{{ route('prints.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black text-nowrap mt-1" style="letter-spacing: 0.2rem">印刷メニュー</div>
    ...
    <a class="text-decoration-none text-reset d-flex " href="{{ route('therapy-periods.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black text-nowrap mt-1" style="letter-spacing: 0.2rem">要加療期間リスト</div>
    ...
    <a class="text-decoration-none text-reset d-flex " href="{{ route('deposits.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black text-nowrap mt-1" style="letter-spacing: 0.2rem">入金管理</div>
