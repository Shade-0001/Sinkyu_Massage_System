    ...
    <div id="home-menu" class="d-flex flex-column">
      <div class="flex-fill">
        <a class="d-flex mb-3 bg-gray-98 rounded-2 border-bevel-light hover-bg-white hover-highlight-20" href="{{ route('records.index') }}">
          <div class="d-flex align-items-center justify-content-center rounded text-white m-2 me-3 fs-2 flex-shrink-0 border-bevel" style="background-color:#e74c3c; aspect-ratio: 1/1;"><i class="nf nf-fa-edit px-4" style="font-size: 3rem;"></i></div>
          <div>
        ...
        <a class="d-flex mb-3 bg-gray-98 rounded-2 border-bevel-light hover-bg-white hover-highlight-20" href="{{ route('reports.index') }}">
          <div class="d-flex align-items-center justify-content-center rounded text-white m-2 me-3 fs-2 flex-shrink-0 border-bevel" style="background-color:#e67e22; aspect-ratio: 1/1;"><i class="nf nf-fa-file_text_o px-4" style="font-size: 3rem;"></i></div>
          <div>
        ...
        <a class="d-flex mb-3 bg-gray-98 rounded-2 border-bevel-light hover-bg-white hover-highlight-20" href="{{ route('schedules.index') }}">
          <div class="d-flex align-items-center justify-content-center rounded text-white m-2 me-3 fs-2 flex-shrink-0 border-bevel" style="background-color:#f1c40f; aspect-ratio: 1/1;"><i class="nf nf-md-calendar_month_outline px-4" style="font-size: 3rem;"></i></div>
          <div>
        ...
        <a class="d-flex mb-3 bg-gray-98 rounded-2 border-bevel-light hover-bg-white hover-highlight-20" href="{{ route('master.index') }}">
          <div class="d-flex align-items-center justify-content-center rounded text-white m-2 me-3 fs-2 flex-shrink-0 border-bevel" style="background-color:#8bc34a; aspect-ratio: 1/1;"><i class="nf nf-oct-gear px-4" style="font-size: 3rem;"></i></div>
          <div>
      ...
      <div class="flex-fill">
        <a class="d-flex mb-3 bg-gray-98 rounded-2 border-bevel-light hover-bg-white hover-highlight-20" href="{{ route('submaster.index') }}">
          <div class="d-flex align-items-center justify-content-center rounded text-white m-2 me-3 fs-2 flex-shrink-0 border-bevel" style="background-color:#27ae60; aspect-ratio: 1/1;"><i class="nf nf-oct-gear px-4" style="font-size: 3rem;"></i></div>
          <div>
        ...
        <a class="d-flex mb-3 bg-gray-98 rounded-2 border-bevel-light hover-bg-white hover-highlight-20" href="{{ route('prints.index') }}">
          <div class="d-flex align-items-center justify-content-center rounded text-white m-2 me-3 fs-2 flex-shrink-0 border-bevel" style="background-color:#3498db; aspect-ratio: 1/1;"><i class="nf nf-md-printer_outline px-4" style="font-size: 3rem;"></i></div>
          <div>
        ...
        <a class="d-flex mb-3 bg-gray-98 rounded-2 border-bevel-light hover-bg-white hover-highlight-20" href="{{ route('therapy-periods.index') }}">
          <div class="d-flex align-items-center justify-content-center rounded text-white m-2 me-3 fs-2 flex-shrink-0 border-bevel" style="background-color:#1a6bb5; aspect-ratio: 1/1;"><i class="nf nf-fa-list px-4" style="font-size: 3rem;"></i></div>
          <div>
        ...
        <a class="d-flex mb-3 bg-gray-98 rounded-2 border-bevel-light hover-bg-white hover-highlight-20" href="{{ route('deposits.index') }}">
          <div class="d-flex align-items-center justify-content-center rounded text-white m-2 me-3 fs-2 flex-shrink-0 border-bevel" style="background-color:#9b59b6; aspect-ratio: 1/1;"><i class="nf nf-fa-yen px-4" style="font-size: 3rem;"></i></div>
          <div>
