<x-app-layout>
  ...
  <div class="mt-2 mx-1 row-gap-4 user-select-none" style="display:grid; grid-template-columns:1fr 1fr; grid-template-rows:repeat(4, auto); grid-auto-flow:column;">
    <a class="text-decoration-none text-reset d-flex min-w-0" href="{{ route('records.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black mt-2" style="letter-spacing: 0.2rem">実績データ</div>
        <div class="text-light-emphasis fw-medium mt-1 mb-3">施術実績の入力・管理</div>
      </div>
    </a>
    <a class="text-decoration-none text-reset d-flex min-w-0" href="{{ route('reports.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black mt-1" style="letter-spacing: 0.2rem">報告書データ</div>
        <div class="text-light-emphasis fw-medium mt-1 mb-3">各種報告書の作成・管理</div>
      </div>
    </a>
    <a class="text-decoration-none text-reset d-flex min-w-0" href="{{ route('schedules.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black mt-1" style="letter-spacing: 0.2rem">スケジュール</div>
        <div class="text-light-emphasis fw-medium mt-1 mb-3">施術スケジュールの確認・管理</div>
      </div>
    </a>
    <a class="text-decoration-none text-reset d-flex min-w-0" href="{{ route('master.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black mt-1" style="letter-spacing: 0.2rem">マスター登録</div>
        <div class="text-light-emphasis fw-medium mt-1 mb-3">患者・医師・施術者等の登録・管理</div>
      </div>
    </a>
    <a class="text-decoration-none text-reset d-flex min-w-0" href="{{ route('submaster.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black mt-1" style="letter-spacing: 0.2rem">サブマスター登録</div>
        <div class="text-light-emphasis fw-medium mt-1 mb-3">医療機関・サービス提供者等の登録・管理</div>
      </div>
    </a>
    <a class="text-decoration-none text-reset d-flex min-w-0" href="{{ route('prints.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black mt-1" style="letter-spacing: 0.2rem">印刷メニュー</div>
        <div class="text-light-emphasis fw-medium mt-1 mb-3">各種帳票の印刷</div>
      </div>
    </a>
    <a class="text-decoration-none text-reset d-flex min-w-0" href="{{ route('therapy-periods.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black mt-1" style="letter-spacing: 0.2rem">要加療期間リスト</div>
        <div class="text-light-emphasis fw-medium mt-1 mb-3">加療期間の一覧管理</div>
      </div>
    </a>
    <a class="text-decoration-none text-reset d-flex min-w-0" href="{{ route('deposits.index') }}">
      ...
      <div>
        <div class="fs-2 text-outline-black mt-1" style="letter-spacing: 0.2rem">入金管理</div>
