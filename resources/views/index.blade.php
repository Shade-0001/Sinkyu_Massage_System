<x-app-layout>
  ...
  <div class="mt-2 mx-1 user-select-none" style="max-width: 1200px;">
    <div id="home-menu" class="d-flex flex-column">
      <div class="flex-fill">
        <a class="d-flex mb-3 bg-white rounded-2" href="{{ route('records.index') }}">
          ...
          <div>
            <div class="text-outline-black text-nowrap mt-3" style="font-size: 2rem; letter-spacing: 0.2rem">実績データ</div>
            <div class="text-light-emphasis fw-medium mt-1 mb-3 text-nowrap">施術実績の入力･管理</div>
          </div>
        </a>
        <a class="d-flex mb-3 bg-white rounded-2" href="{{ route('reports.index') }}">
          ...
          <div>
            <div class="text-outline-black text-nowrap mt-3" style="font-size: 2rem; letter-spacing: 0.2rem">報告書データ</div>
        ...
        <a class="d-flex mb-3 bg-white rounded-2" href="{{ route('schedules.index') }}">
          ...
          <div>
            <div class="text-outline-black text-nowrap mt-3" style="font-size: 2rem; letter-spacing: 0.2rem">スケジュール</div>
        ...
        <a class="d-flex mb-3 bg-white rounded-2" href="{{ route('master.index') }}">
          ...
          <div>
            <div class="text-outline-black text-nowrap mt-3" style="font-size: 2rem; letter-spacing: 0.2rem">マスター登録</div>
      ...
      <div class="flex-fill">
        <a class="d-flex mb-3 bg-white rounded-2" href="{{ route('submaster.index') }}">
          ...
          <div>
            <div class="text-outline-black text-nowrap mt-3" style="font-size: 2rem; letter-spacing: 0.2rem">サブマスター登録</div>
        ...
        <a class="d-flex mb-3 bg-white rounded-2" href="{{ route('prints.index') }}">
          ...
          <div>
            <div class="text-outline-black text-nowrap mt-3" style="font-size: 2rem; letter-spacing: 0.2rem">印刷メニュー</div>
        ...
        <a class="d-flex mb-3 bg-white rounded-2" href="{{ route('therapy-periods.index') }}">
          ...
          <div>
            <div class="text-outline-black text-nowrap mt-3" style="font-size: 2rem; letter-spacing: 0.2rem">要加療期間リスト</div>
        ...
        <a class="d-flex mb-3 bg-white rounded-2" href="{{ route('deposits.index') }}">
          ...
          <div>
            <div class="text-outline-black text-nowrap mt-3" style="font-size: 2rem; letter-spacing: 0.2rem">入金管理</div>
