  ...
  <nav class="p-0">
    <ul class="list-unstyled">
      ...
      <li class="border-bottom border-1 border-secondary">
        ...
        <ul id="master-submenu" class="submenu bg-dark bg-opacity-75 list-unstyled overflow-hidden border-top border-1 border-secondary">
          <li class="border-bottom border-secondary"><a href="{{ route('clinic-users.index') }}" class="submenu-link text-light opacity-75 small py-2 px-3 d-block text-decoration-none fw-normal user-select-none">利用者</a></li>
          <li class="border-bottom border-secondary"><a href="{{ route('doctors.index') }}" class="submenu-link text-light opacity-75 small py-2 px-3 d-block text-decoration-none fw-normal user-select-none">医師</a></li>
          <li class="border-bottom border-secondary"><a href="{{ route('therapists.index') }}" class="submenu-link text-light opacity-75 small py-2 px-3 d-block text-decoration-none fw-normal user-select-none">施術者</a></li>
          <li class="border-bottom border-secondary"><a href="{{ route('caremanagers.index') }}" class="submenu-link text-light opacity-75 small py-2 px-3 d-block text-decoration-none fw-normal user-select-none">ケアマネ</a></li>
          <li class="border-bottom border-secondary"><a href="{{ route('clinic-info.index') }}" class="submenu-link text-light opacity-75 small py-2 px-3 d-block text-decoration-none fw-normal user-select-none">自社情報</a></li>
          <li class="border-bottom border-secondary"><a href="{{ route('master.documents.index') }}" class="submenu-link text-light opacity-75 small py-2 px-3 d-block text-decoration-none fw-normal user-select-none">文面編集</a></li>
          <li class="border-bottom border-secondary"><a href="{{ route('master.treatment-fees.index') }}" class="submenu-link text-light opacity-75 small py-2 px-3 d-block text-decoration-none fw-normal user-select-none">施術料金</a></li>
          <li class="border-bottom border-secondary"><a href="{{ route('master.self-fees.index') }}" class="submenu-link text-light opacity-75 small py-2 px-3 d-block text-decoration-none fw-normal user-select-none">自費施術料金</a></li>
          <li class="border-bottom border-secondary"><a href="{{ route('master.document-association.index') }}" class="submenu-link text-light opacity-75 small py-2 px-3 d-block text-decoration-none fw-normal user-select-none">登録済み標準文書の確認･関連付け</a></li>
        </ul>
      </li>
      <li class="border-bottom border-1 border-secondary">
