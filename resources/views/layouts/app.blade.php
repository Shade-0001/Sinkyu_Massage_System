	...
	<head>
		...
		@php
			...
			$faviconPaths = match(true) {
				...
				request()->is('reports', 'reports/*')                 => [['symbol' => 'M320-440h320v-80H320v80Zm0 120h320v-80H320v80Zm0 120h200v-80H320v80ZM240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h320l240 240v480q0 33-23.5 56.5T720-80H240Zm280-520v-200H240v640h480v-440H520ZM240-800v200-200 640-640Z']],                                                                                                                                                                                                                        // ファイル（報告書）
				...
				request()->is('prints', 'prints/*')                   => [['d' => 'M19 8H5a3 3 0 0 0-3 3v6h4v4h12v-4h4v-6a3 3 0 0 0-3-3zm-3 11H8v-5h8zm3-7a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-1-9H6v4h12z']],                                                                                                                                                                                                                    // プリンター（印刷）
				request()->is('therapy-periods', 'therapy-periods/*') => [['d' => 'M3 13h2v-2H3zm0 4h2v-2H3zm0-8h2V7H3zm4 4h14v-2H7zm0 4h14v-2H7zM7 7v2h14V7z']],                                                                                                                                                                                                                                                            // リスト（要加療期間）
				request()->is('deposits', 'deposits/*')               => [['symbol' => 'M440-120v-160H240v-80h200v-80H240v-80h163L200-840h95l185 292 185-292h95L557-520h163v80H520v80h200v80H520v160h-80Z']],                                                                                                                                                                                                                             // 円マーク（入金）
