...
<html lang="ja">
	<head>
		...
		@php
			// ----- favicon アイコン定義 -----
			// 'symbol' キー : Material Symbols (viewBox="0 -960 960 960") のパス
			// 'd'      キー : Material Design 24px (viewBox="0 0 24 24") のパス

			$faviconIcon = match(true) {
				...
				request()->is('reports',         'reports/*')         => ['symbol' => 'M320-440h320v-80H320v80Zm0 120h320v-80H320v80Zm0 120h200v-80H320v80ZM240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h320l240 240v480q0 33-23.5 56.5T720-80H240Zm280-520v-200H240v640h480v-440H520ZM240-800v200-200 640-640Z'],                                                                                                                          // docs
				request()->is('schedules',       'schedules/*')       => ['symbol' => 'M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Zm0-480h560v-80H200v80Zm0 0v-80 80Zm280 240q-17 0-28.5-11.5T440-440q0-17 11.5-28.5T480-480q17 0 28.5 11.5T520-440q0 17-11.5 28.5T480-400Zm-188.5-11.5Q280-423 280-440t11.5-28.5Q303-480 320-480t28.5 11.5Q360-457 360-440t-11.5 28.5Q337-400 320-400t-28.5-11.5ZM640-400q-17 0-28.5-11.5T600-440q0-17 11.5-28.5T640-480q17 0 28.5 11.5T680-440q0 17-11.5 28.5T640-400ZM480-240q-17 0-28.5-11.5T440-280q0-17 11.5-28.5T480-320q17 0 28.5 11.5T520-280q0 17-11.5 28.5T480-240Zm-188.5-11.5Q280-263 280-280t11.5-28.5Q303-320 320-320t28.5 11.5Q360-297 360-280t-11.5 28.5Q337-240 320-240t-28.5-11.5ZM640-240q-17 0-28.5-11.5T600-280q0-17 11.5-28.5T640-320q17 0 28.5 11.5T680-280q0 17-11.5 28.5T640-240Z'], // calendar_month
				request()->is('master',          'master/*')          => ['d'      => 'M19.43 12.98c.04-.32.07-.64.07-.98s-.03-.66-.07-.98l2.1-1.64a.5.5 0 0 0 .12-.64l-2-3.46a.5.5 0 0 0-.61-.22l-2.49 1a7.4 7.4 0 0 0-1.68-.98l-.38-2.65A.49.49 0 0 0 14 2h-4a.49.49 0 0 0-.49.42l-.38 2.65c-.61.25-1.17.59-1.68.98l-2.49-1a.49.49 0 0 0-.61.22l-2 3.46a.48.48 0 0 0 .12.64l2.1 1.64c-.04.32-.07.65-.07.99s.03.66.07.98l-2.1 1.64a.49.49 0 0 0-.12.64l2 3.46c.12.22.37.3.61.22l2.49-1c.51.39 1.07.73 1.68.98l.38 2.65c.07.38.39.65.49.65h4c.27 0 .49-.2.49-.42l.38-2.65c.61-.25 1.17-.59 1.68-.98l2.49 1c.23.09.49 0 .61-.22l2-3.46a.49.49 0 0 0-.12-.64zM12 15.5a3.5 3.5 0 1 1 0-7 3.5 3.5 0 0 1 0 7z'],  // settings
				request()->is('submaster',       'submaster/*')       => ['d'      => 'M19.43 12.98c.04-.32.07-.64.07-.98s-.03-.66-.07-.98l2.1-1.64a.5.5 0 0 0 .12-.64l-2-3.46a.5.5 0 0 0-.61-.22l-2.49 1a7.4 7.4 0 0 0-1.68-.98l-.38-2.65A.49.49 0 0 0 14 2h-4a.49.49 0 0 0-.49.42l-.38 2.65c-.61.25-1.17.59-1.68.98l-2.49-1a.49.49 0 0 0-.61.22l-2 3.46a.48.48 0 0 0 .12.64l2.1 1.64c-.04.32-.07.65-.07.99s.03.66.07.98l-2.1 1.64a.49.49 0 0 0-.12.64l2 3.46c.12.22.37.3.61.22l2.49-1c.51.39 1.07.73 1.68.98l.38 2.65c.07.38.39.65.49.65h4c.27 0 .49-.2.49-.42l.38-2.65c.61-.25 1.17-.59 1.68-.98l2.49 1c.23.09.49 0 .61-.22l2-3.46a.49.49 0 0 0-.12-.64zM12 15.5a3.5 3.5 0 1 1 0-7 3.5 3.5 0 0 1 0 7z'],  // settings
				request()->is('prints',          'prints/*')          => ['d'      => 'M19 8H5a3 3 0 0 0-3 3v6h4v4h12v-4h4v-6a3 3 0 0 0-3-3zm-3 11H8v-5h8zm3-7a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-1-9H6v4h12z'],                                                                                                                                                                                                                    // print
				request()->is('therapy-periods', 'therapy-periods/*') => ['d'      => 'M3 13h2v-2H3zm0 4h2v-2H3zm0-8h2V7H3zm4 4h14v-2H7zm0 4h14v-2H7zM7 7v2h14V7z'],                                                                                                                                                                                                                                                            // list
				request()->is('deposits',        'deposits/*')        => ['symbol' => 'M440-120v-160H240v-80h200v-80H240v-80h163L200-840h95l185 292 185-292h95L557-520h163v80H520v80h200v80H520v160h-80Z'],                                                                                                                                                                                                                        // currency_yen
				request()->is('admin-panel',     'admin-panel/*')     => ['d'      => 'M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5zm0 4a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm0 14c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08s5.97 1.09 6 3.08A7.24 7.24 0 0 1 12 19z'],                                                                                                                                              // shield
				default                                               => ['d'      => 'M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z'],                                                                                                                                                                                                                                                                                                     // home
			};
