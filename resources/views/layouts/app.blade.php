	...
	<head>
		...
		@php
			...
			$faviconPaths = match(true) {
				request()->is('records', 'records/*')                 => [['d' => 'M3 17.25V21h3.75L17.81 9.94l-3.75-3.75zM20.71 7.04a1 1 0 0 0 0-1.41l-2.34-2.34a1 1 0 0 0-1.41 0l-1.83 1.83 3.75 3.75z']],                                                                                                                                                                                                               // 鉛筆（実績）
				...
				request()->is('deposits', 'deposits/*')               => [['d' => 'M12 3L6.5 10H10v1.5H6.5v1.5H10V14H6.5v1.5H10V21h4v-5.5h3.5V14H14v-1H17.5v-1.5H14V10h3.5z']],                                                                                                                                                                                                                             // 円マーク（入金）
			...
			$pathTags = implode('', array_map(fn($p) => '<path fill="white" d="' . $p['d'] . '"/>', $faviconPaths));
