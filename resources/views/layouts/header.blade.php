<div class="px-3 d-flex align-items-center gap-3 fw-bold">
  ...
  <a href="{{route('index')}}" class="text-decoration-none text-gray-90 py-1 px-2 rounded-1 hover-highlight-30 highlight-target-text-white"><i class="nf nf-fa-home me-1" style="vertical-align:middle; position:relative; top:1px;"></i>ホーム</a>
