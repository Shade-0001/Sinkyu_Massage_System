      ...
      <div class="text-center position-relative" style="width: 15rem;">
        <div class="d-flex align-items-center justify-content-center gap-1">
          ...
          <div class="position-relative" style="display: inline-block;">
            <div id="calendar-title-display" class="fs-4 fw-bold py-1 d-inline-block" style="cursor: pointer; background-color: ButtonFace; border-radius: 4px; padding: 0.05em 0.5em;"></div>
