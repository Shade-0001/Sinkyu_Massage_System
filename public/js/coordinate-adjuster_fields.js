...
const fieldDefinitions = {
  ...
  'fee_therapy_report_unit': { field: 'fee_therapy_report_unit', label: '単価', type: 'number', compositeGroup: 'fee_therapy_report', compositeLabel: '施術報告書交付料', optionLabel: '単価' },
  'fee_therapy_report_count': { field: 'fee_therapy_report_count', label: '回数', type: 'number', compositeGroup: 'fee_therapy_report', compositeLabel: '施術報告書交付料', optionLabel: '回数' },
  'fee_therapy_report_total': { field: 'fee_therapy_report_total', label: '合計', type: 'number', compositeGroup: 'fee_therapy_report', compositeLabel: '施術報告書交付料', optionLabel: '合計' },
  'previous_benefit_year': { field: 'previous_benefit_year', label: '年', type: 'number', compositeGroup: 'previous_benefit', compositeLabel: '前回支給年月', optionLabel: '年' },
  'previous_benefit_month': { field: 'previous_benefit_month', label: '月', type: 'number', compositeGroup: 'previous_benefit', compositeLabel: '前回支給年月', optionLabel: '月' },
