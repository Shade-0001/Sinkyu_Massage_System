...
const sampleDataFieldMapping = {
  ...
  'birthday_full_date': { field: 'birthday_year', label: '年月日', type: 'text', combine: ['birthday_year', 'birthday_month', 'birthday_day'], compositeGroup: 'birthday_full_date', compositeLabel: '生年月日' },
