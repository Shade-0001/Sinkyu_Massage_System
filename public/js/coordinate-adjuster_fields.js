...
const fieldDefinitionsConsentMassage = {
  ...
  // === 症状カテゴリ（マッサージ用） ===
  'muscle_paralysis_trunk': { field: 'muscle_paralysis', label: '筋麻痺･委縮（楕円描画）', type: 'select', options: ['躯幹', '右上肢', '左上肢', '右下肢', '左下肢'], ellipseWidth: 6, ellipseHeight: 3, lineWidth: 0.5, radioGroup: 'muscle_paralysis', optionLabel: '躯幹' },
  'muscle_paralysis_upper_limb_r': { field: 'muscle_paralysis', label: '筋麻痺･委縮（楕円描画）', type: 'select', options: ['躯幹', '右上肢', '左上肢', '右下肢', '左下肢'], ellipseWidth: 6, ellipseHeight: 3, lineWidth: 0.5, radioGroup: 'muscle_paralysis', optionLabel: '右上肢' },
  'muscle_paralysis_upper_limb_l': { field: 'muscle_paralysis', label: '筋麻痺･委縮（楕円描画）', type: 'select', options: ['躯幹', '右上肢', '左上肢', '右下肢', '左下肢'], ellipseWidth: 6, ellipseHeight: 3, lineWidth: 0.5, radioGroup: 'muscle_paralysis', optionLabel: '左上肢' },
  'muscle_paralysis_lower_limb_r': { field: 'muscle_paralysis', label: '筋麻痺･委縮（楕円描画）', type: 'select', options: ['躯幹', '右上肢', '左上肢', '右下肢', '左下肢'], ellipseWidth: 6, ellipseHeight: 3, lineWidth: 0.5, radioGroup: 'muscle_paralysis', optionLabel: '右下肢' },
  'muscle_paralysis_lower_limb_l': { field: 'muscle_paralysis', label: '筋麻痺･委縮（楕円描画）', type: 'select', options: ['躯幹', '右上肢', '左上肢', '右下肢', '左下肢'], ellipseWidth: 6, ellipseHeight: 3, lineWidth: 0.5, radioGroup: 'muscle_paralysis', optionLabel: '左下肢' },
