...
const sampleDataFieldMapping = {
  ...
  // === 11. 施術料金（鍼灸） ===
  'fee_hari_unit': { field: 'fee_hari_unit', label: '単価', type: 'number', compositeGroup: 'fee_hari', compositeLabel: 'はり' },
  'fee_hari_count': { field: 'fee_hari_count', label: '回数', type: 'number', compositeGroup: 'fee_hari', compositeLabel: 'はり' },
  'fee_hari_total': { field: 'fee_hari_total', label: '合計', type: 'number', compositeGroup: 'fee_hari', compositeLabel: 'はり' },
  'fee_hari_electric_unit': { field: 'fee_hari_electric_unit', label: '単価', type: 'number', compositeGroup: 'fee_hari_electric', compositeLabel: 'はり（電気鍼併用）' },
  'fee_hari_electric_count': { field: 'fee_hari_electric_count', label: '回数', type: 'number', compositeGroup: 'fee_hari_electric', compositeLabel: 'はり（電気鍼併用）' },
  'fee_hari_electric_total': { field: 'fee_hari_electric_total', label: '合計', type: 'number', compositeGroup: 'fee_hari_electric', compositeLabel: 'はり（電気鍼併用）' },
  'fee_kyu_unit': { field: 'fee_kyu_unit', label: '単価', type: 'number', compositeGroup: 'fee_kyu', compositeLabel: 'きゅう' },
  'fee_kyu_count': { field: 'fee_kyu_count', label: '回数', type: 'number', compositeGroup: 'fee_kyu', compositeLabel: 'きゅう' },
  'fee_kyu_total': { field: 'fee_kyu_total', label: '合計', type: 'number', compositeGroup: 'fee_kyu', compositeLabel: 'きゅう' },
  'fee_kyu_electric_unit': { field: 'fee_kyu_electric_unit', label: '単価', type: 'number', compositeGroup: 'fee_kyu_electric', compositeLabel: 'きゅう（電気温灸器併用）' },
  'fee_kyu_electric_count': { field: 'fee_kyu_electric_count', label: '回数', type: 'number', compositeGroup: 'fee_kyu_electric', compositeLabel: 'きゅう（電気温灸器併用）' },
  'fee_kyu_electric_total': { field: 'fee_kyu_electric_total', label: '合計', type: 'number', compositeGroup: 'fee_kyu_electric', compositeLabel: 'きゅう（電気温灸器併用）' },
  'fee_hari_kyu_unit': { field: 'fee_hari_kyu_unit', label: '単価', type: 'number', compositeGroup: 'fee_hari_kyu', compositeLabel: 'はり･きゅう併用' },
  'fee_hari_kyu_count': { field: 'fee_hari_kyu_count', label: '回数', type: 'number', compositeGroup: 'fee_hari_kyu', compositeLabel: 'はり･きゅう併用' },
  'fee_hari_kyu_total': { field: 'fee_hari_kyu_total', label: '合計', type: 'number', compositeGroup: 'fee_hari_kyu', compositeLabel: 'はり･きゅう併用' },
  'fee_hari_kyu_electric_unit': { field: 'fee_hari_kyu_electric_unit', label: '単価', type: 'number', compositeGroup: 'fee_hari_kyu_electric', compositeLabel: 'はり･きゅう併用（電気鍼･電気温灸器併用）' },
  'fee_hari_kyu_electric_count': { field: 'fee_hari_kyu_electric_count', label: '回数', type: 'number', compositeGroup: 'fee_hari_kyu_electric', compositeLabel: 'はり･きゅう併用（電気鍼･電気温灸器併用）' },
  'fee_hari_kyu_electric_total': { field: 'fee_hari_kyu_electric_total', label: '合計', type: 'number', compositeGroup: 'fee_hari_kyu_electric', compositeLabel: 'はり･きゅう併用（電気鍼･電気温灸器併用）' },
