...
const sampleDataFieldMapping = {
  ...
  // === 8. 初療年月日・施術期間 ===
  'first_treatment_date': { field: 'first_treatment_date', label: '初療年月日', type: 'text', compositeGroup: 'first_treatment_date_composite', compositeLabel: '初療年月日' },
  ...
  'treatment_start_date': { field: 'treatment_start_date', label: '施術期間（開始）', type: 'text', compositeGroup: 'treatment_start_date_composite', compositeLabel: '施術期間（開始）' },
  ...
  'treatment_end_date': { field: 'treatment_end_date', label: '施術期間（終了）', type: 'text', compositeGroup: 'treatment_end_date_composite', compositeLabel: '施術期間（終了）' },
